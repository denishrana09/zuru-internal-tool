...
import EditEmployeeDetails from '../../components/editEmployeeDetails/editEmployeeDetails'
...
class userHome extends Component {
    ...
    render() {
        ...
        if (!auth || role !== "361959476645593089") {
            return <Redirect to='/' />
        }
        return (
            <div>
                        ...
                        <div className="col-md-12 col-xs-12 text-center">
                            <AppBar position="static" color="default" className="" >
                                <Tabs value={this.state.tabValue} onChange={this.handleChange}
                                    ...
                                    <Tab className="appBarTab" label="Edit Employee Details" />
